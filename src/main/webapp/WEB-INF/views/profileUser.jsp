   ...
   <div class="generic-container" ng-controller="ProfileController as ctrl">
		...
		<div class="container"> 
         ...
         <!--       <form name="form"  class="form-horizontal" >-->  
           	...
           	<table>
           	<tr>
           	<td align="center"><div id="foo"></div></td></tr>
           	<tr>
           	<td><p><h2><span ng-bind="ctrl.user.firstname"></span>&nbsp;&nbsp;<span ng-bind="ctrl.user.lastname"></span></h2></p></td></tr>
           ...
           <div id="col1">
                ...
                <input type="file" id="filePicker"> </p>
           		<p> <label>MetaTag : </label></p>
              <p> 	 <input type="text" ng-model="ctrl.tag" name="tag" class="metaTag form-control input-sm" placeholder="Write your metaTag" required ng-minlength="3" ng-required="string"/></p>  
  			<p>	<label>Access's Rule: </label></p>
  			<p> <input type="number" ng-model="ctrl.rule" name="rule" class="rule form-control input-sm" placeholder="Write your access rule" min="1" max="7" step="1"/></p>
  			  
       		<p><label>PassPhrase</label>	</p>
       		<p><input type="password" ng-model="ctrl.passPhrase" name="passPhrase" class="passPhraseform-control input-sm" placeholder="Write your passPhrase" required ng-minlength="3"/></p>
   
       <p><button type="submit" ng-click="ctrl.uploadPhotoRule()" class="btn btn-primary btn-sm" ng-disabled="myForm.$invalid"/>Upload Photo</button></p>
             ...
             <h4>{{ctrl.message}}</h4>
                          ...
                          <tr ng-repeat="u in ctrl.users">
                            <a ng-href="/OSN/userView/{{ctrl.id}}/{{u.id}}?{{u.firstName}}{{u.lastName}}"><span ng-bind="u.lastName"></a>
